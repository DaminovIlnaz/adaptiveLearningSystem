...
public class BKT_simulated {
    ...
    public static void main(String args[]) {
        ...
        String infile_ = "файл с результатами тестирования";
        // num	lesson	student	skill	cell	right	eol
        // 1	Z3.Three-FactorZCros2008	student102	META-DETERMINE-DXO	cell	0	eol
        BKT_simulated bkt = new BKT_simulated();
        bkt.computelzerot(infile_);
